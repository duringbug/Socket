 ...
 * @Description: 
 * @Author: 唐健峰
 * @Date: 2023-05-05 11:24:16
 * @LastEditors: ${author}
 * @LastEditTime: 2023-05-05 11:33:11
 */
...
public class NIOServer2 {
    ...
    private void accept(SelectionKey key) throws IOException { 
        ...
        SocketAddress remoteAddr = socket.getRemoteSocketAddress(); System.out.println("已连接: " + remoteAddr);
        // 监听读事件
    ...
    private void read(SelectionKey key) throws IOException {
        ...
        byte[] data = new byte[numRead]; System.arraycopy(buffer.array(), 0, data, 0, numRead); 
